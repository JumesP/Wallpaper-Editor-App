...
def Pattern1(location):
    ...
    pattern1.bind("<Button-1>", Pattern_clicked)
...
def Pattern2(location):
    ...
    pattern2.bind("<Button-1>", Pattern_clicked)
...
def checkout_button_clicked(event):     # Homepage Checkout Button
    print(event.widget._name + " clicked")
    checkout_selected()


def menu_button_clicked(event):     # Homepage Menu Button
    print(event.widget._name + " clicked")
